export default function Footer() {
	return (
		<footer className='bottom-0 flex w-full flex-row flex-wrap items-center justify-center gap-y-6 gap-x-12 border-t border-blue-gray-50 py-6 text-center md:justify-between md:mx-auto '>
