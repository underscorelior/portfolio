...
function ProjectCards({
	...
	return (
		<div
			className={
				'4xl:w-[75%] mx-auto flex h-auto w-[90%] items-center justify-center overflow-hidden rounded-lg drop-shadow-xl md:w-2/3 lg:w-[90%] 2xl:w-full' +
				(centered
					? ' 4xl:max-w-[calc(37.5%-1.25rem)] md:col-span-2 md:max-w-[calc(50%-1.25rem)]'
					: '')
			}>
			<a
				href={url}
	...
	return (
		<section
			...
			<ProjectCards
				...
				desc={
					<>
						A Wordle-inspired geography game where each guess reveals more of a
						country’s borders. Built in collaboration with{' '}
						<a
