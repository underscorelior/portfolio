...
export default function About() {
	return (
		<div
			id="about"
			className="4xl:w-[65%] mx-auto flex w-[85%] flex-col items-center justify-center pt-28 lg:w-[80%]">
			<h1 className="text-5xl font-black">About</h1>

			<div className="4xl:grid-cols-[15%,2.5%,82.5%] flex flex-col items-center justify-center pt-8 lg:grid lg:grid-cols-[25%,5%,70%] lg:pt-4">
				<img
					src={me}
					alt="Picture of me"
					className="4xl:w-[90%] my-auto aspect-square h-auto w-[45%] rounded-xl lg:w-[95%]"
					height={'full'}
					width={'full'}
				/>
				<p className="tracking col-start-3 self-center pt-4 text-2xl font-medium">
					Hey! I'm Lior Pendler, a freshman at UC Irvine and a software
					engineering intern at Readwise. I have experience across a wide range
					of development tools and languages, including:
					...
					, and more. I love working on projects, especially those that
					challenge me to learn new skills and technologies, like{'	'}
					<a
						href="https://unisearch.app"
						target="_blank"
						className="text-slate-700 underline">
						UniSearch
					</a>
					, a tool I built to help students explore and compare colleges more
					effectively.
				</p>
			</div>
		</div>
