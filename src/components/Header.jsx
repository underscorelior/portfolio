...
class Header extends Component {
	render() {
		return (
			<header className="relative mx-auto pt-12 flex w-full justify-center xl:pt-28 2xl:pt-[13.5rem] 2xl:pb-[8.5%] 3xl:pb-[10rem] 3xl:pt-[18rem] 4xl:pb-[20rem] 4xl:pt-[25rem]">
