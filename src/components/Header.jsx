				...
				<div className="mt-8 flex w-full flex-col items-center gap-x-6 gap-y-4 md:flex-row">
					...
					<section className="flex w-full flex-row justify-between gap-x-4 md:justify-start md:gap-x-6">
						<a
							...
							aria-label="github"
							className="w-auto rounded-xl border-2 bg-[#313030] p-[1rem] text-4xl text-white duration-300 hover:bg-[#181717] md:p-[1.125rem] md:text-3xl">
							<SiGithub />
						</a>
						<a
						...
						<a
							...
							rel="noopener noreferrer"
							aria-label="linkedin"
							className="w-auto rounded-xl border-2 bg-[#0073b1] p-[1rem] text-4xl text-white duration-300 hover:bg-[#005E93] md:p-[1.125rem] md:text-3xl">
							<SiLinkedin />
						</a>
					</section>
				</div>
