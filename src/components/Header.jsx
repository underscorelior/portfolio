...
class Header extends Component {
	render() {
		return (
			<header className="relative mx-auto mt-12 flex w-full justify-center xl:mt-28 3xl:mt-[18rem] 3xl:mb-[10rem] 4xl:mt-[25rem] 4xl:mb-[20rem]">
				...
				<section className="relative flex h-full w-full max-w-[85%] flex-col justify-center rounded-lg sm:max-w-[70%] lg:w-[81%] lg:max-w-[75%]">
					<h1 className="text-center text-[2.5rem] sm:text-5xl font-semibold leading-[3.25rem] md:leading-[3.5rem] text-neutral-900 md:text-left md:text-6xl lg:w-[81%] lg:text-7xl lg:font-medium 3xl:w-[50%]">
						{header.subtitle}
					</h1>
					...
					<div className="mt-8 flex w-full flex-col items-center gap-x-6 gap-y-4 md:flex-row">
						...
						<section className="flex w-full flex-row justify-between md:justify-start gap-x-4 md:gap-x-6">
							<a
